...
import com.isiseko.org.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/isiseko-kafka")
public class IsisekoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IsisekoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public IsisekoKafkaResource(KafkaProperties kafkaProperties) {
